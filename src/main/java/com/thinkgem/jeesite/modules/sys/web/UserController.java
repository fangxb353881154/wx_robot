...
public class UserController extends BaseController {
	...
	public String info(User user, HttpServletResponse response, Model model) {
		...
		userItem.setUserId(currentUser.getId());
		userItem.getSqlMap().put("dsf", " AND lines_count > 0 ");//查出有额度项目
		List<JfAgentUserItem> userItemList = jfAgentUserItemService.findList(userItem);
